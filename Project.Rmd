...
```{r Intra Game, echo = FALSE, warning = FALSE, message = FALSE}
set.seed(2004)
...
```{r Intra GAM Output, echo = FALSE, message = FALSE}
FF_preds %>%
...
```{r Inter GAM Output, echo = FALSE, message = FALSE, warning = FALSE}
